		...
		if (as === 'a') {
			return (
				<a
					...
					rel={rel}
					target={target}
					className={`flex flex-row items-center justify-start gap-2 rounded-full border px-2 py-2 text-sm transition-colors duration-200 md:px-5 md:py-3 md:text-base ${buttonClassName} ${
