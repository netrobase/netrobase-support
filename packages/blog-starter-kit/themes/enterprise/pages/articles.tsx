...
export default function Index({ publication, initialAllPosts, initialPageInfo }: Props) {
	...
	return (
		<AppProvider publication={publication}>
			<Layout>
				<Head>
					<title>{publication.displayTitle || publication.title || 'Netrobase Engineering'}</title>
					<meta
						name="description"
						content={
							publication.descriptionSEO ||
							publication.title ||
							'We deliver custom software development and maintenance services to businesses and institutions.'
						}
					/>
					<meta property="twitter:card" content="summary_large_image" />
					<meta
						property="twitter:title"
						content={publication.displayTitle || publication.title || 'Netrobase Engineering'}
					/>
					<meta
